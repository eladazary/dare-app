export const COLORS = {
  ...
  // Primary accent — gold
  amber: '#B8860B',         // gold — all CTAs, active states, trace color
  ...
  // REDACTED theme — trace card
  cream: '#F5F0E8',         // aged paper — trace card background (only non-dark element)
  creamDim: '#E8E2D6',      // slightly darker cream — trace card borders/lines
